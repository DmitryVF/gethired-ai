...
import { NEW_OPP_STEP_5 } from "../../../routes";
...
function OppoInfoForm4({ defaultValues, setFormValues, bottomPanelRef }) {
  const classes = useStyles();
  const {handleSubmit, setValue, watch, register, errors, control, 
  } = useForm({
    defaultValues: {},
    validationSchema: formSchemas.oppoInfoStep4
  });
...
const defaultValues = {
  willDo: ["Plan, structure and implement applications, websites, APIs, databases, etc.",
...
export default connect(mapStateToProps, mapDispatchToProps)(OppoInfoForm4)
