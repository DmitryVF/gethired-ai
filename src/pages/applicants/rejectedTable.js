...
import { APP_REJECTED_VIEW } from '../../routes';
            ...
            <TableRow key={idx}>
              <StyledTableCell component="th" scope="row">
                <Grid container spacing={1} alignItems="center">
                  <Grid item>
                    <Avatar className={classes.avatar}><DefaultAvatarSvg /></Avatar>
                  </Grid>
                  <Grid item>
                    <Box color="#C4C4C4" pl={1 / 2}>{name}</Box>
                  </Grid>
                </Grid>
              </StyledTableCell>
              ...
              <Box textAlign="center">
                <Typography  variant="caption" className={classes.normal}>
                  Rejected, {status}
                </Typography>
              </Box>  
                <Box mt="12px" minWidth='227px' >
                <Link to={APP_REJECTED_VIEW} className={classes.link}>
                  <Button size="medium">
                    View Application
                  </Button>
                </Link>  
